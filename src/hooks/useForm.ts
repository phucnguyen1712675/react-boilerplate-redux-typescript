...
/**
 * This function is type inference ready and will auto-validate the useForm
 *  with the proper values.
 *
 * If you don't already have the schema or use a dynamic schema, consider
...
/**
 * Use this to prevent importing yup library in your components, if you don't
 *   already have the schema, and if you want to have a dynamic schema values.
 * This is rebuild on each render.
 * This function is type inference ready and will auto-validate the useForm
 *  with the proper values.
 *
 * If you have already the schema or use a static schema, consider
 *  useFormWithSchema()
 *
